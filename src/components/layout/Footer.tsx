...
const socialLinks = [
  {
    label: "TikTok",
    href: "https://tiktok.com/@altaraf_sa",
    icon: (
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12.206 0c-5.34 0-8.69 3.458-8.69 8.77 0 .34.018.678.053 1.01-.47.078-.91.24-1.266.5-.24.175-.44.425-.44.76 0 .13.03.26.075.39.284.805 1.26 1.14 2.05 1.38-.074.47-.69 1.934-1.926 2.725-.45.288-.75.76-.75 1.23 0 .87.765 1.26 1.68 1.47.05.012.08.06.08.11 0 .034.004.068.014.1.12.375.41.53.72.66.26.11.534.153.82.153.2 0 .4-.022.6-.045.267-.032.52-.063.77-.063.37 0 .69.07 1.02.244.61.32 1.27.545 2.07.545.81 0 1.46-.225 2.07-.545.33-.174.65-.244 1.02-.244.25 0 .504.03.77.063.2.023.4.045.6.045.287 0 .56-.042.82-.153.31-.13.6-.284.72-.66.01-.032.014-.066.014-.1 0-.05.03-.098.08-.11.915-.21 1.68-.6 1.68-1.47 0-.47-.3-.942-.75-1.23-1.235-.79-1.852-2.255-1.926-2.725.79-.24 1.766-.575 2.05-1.38.045-.13.075-.26.075-.39 0-.335-.2-.585-.44-.76-.355-.26-.796-.422-1.266-.5.035-.332.053-.67.053-1.01C20.896 3.458 17.547 0 12.206 0z" />
      </svg>
    ),
  },
  {
  ...
  {
    label: "Facebook",
    href: "https://facebook.com/AlTaraf.sa",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2 mt-5">
              {socialLinks.map((s) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.label}
                  className="w-10 h-10 flex items-center justify-center rounded-lg bg-white/5 border border-white/15 text-white/80 hover:text-white hover:bg-white/10 hover:border-white/25 transition-colors"
                >
                  {s.icon}
                </a>
              ))}
