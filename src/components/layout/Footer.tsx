...
const quickLinks = [
  ...
  { label: "تواصل معنا", href: "tel:920018173" },
];
...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 1.5c-4.5 0-7 3.2-7 7.3v2.6c0 .5-.1 1-.3 1.5-.3.7-.8 1.2-1.5 1.7-.3.2-.6.3-.9.5-.6.3-.6.9 0 1.2.5.3 1.1.5 1.6.6-.1.3-.3.6-.5.9-.3.4 0 .9.5.9.4 0 .8-.1 1.1-.2.3-.1.7-.2 1.1-.2.3 0 .6.1.8.3.4.3.7.7 1.2 1 .9.6 2 .9 3.1.9s2.2-.3 3.1-.9c.5-.3.8-.7 1.2-1 .2-.2.5-.3.8-.3.4 0 .8.1 1.1.2.3.1.7.2 1.1.2.5 0 .8-.5.5-.9-.2-.3-.4-.6-.5-.9.5-.1 1.1-.3 1.6-.6.6-.3.6-.9 0-1.2-.3-.2-.6-.3-.9-.5-.7-.5-1.2-1-1.5-1.7-.2-.5-.3-1-.3-1.5V8.8c0-4.1-2.5-7.3-7-7.3z" />
      </svg>
    ),
  },
  {
