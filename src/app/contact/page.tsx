...
export const metadata: Metadata = {
  title: "تواصل معنا | الترف للاستقدام",
  description:
    "تواصل مع الترف للاستقدام في الرياض. نسعد بخدمتك والإجابة على جميع استفساراتك حول خدمات الاستقدام والتأجير الشهري.",
  keywords: [
    "تواصل معنا",
    "الترف للاستقدام",
    "استقدام الرياض",
...
const contactInfo = [
  ...
  },
  {
    ...
    value: "info@altaraf.sa",
    href: "mailto:info@altaraf.sa",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    ...
                    <div>
                      ...
                      {info.href ? (
                        <a
                          ...
                          dir={info.label === "البريد الإلكتروني" || info.label === "الموقع الإلكتروني" ? "ltr" : undefined}
                          style={
                            info.label === "البريد الإلكتروني" || info.label === "الموقع الإلكتروني"
