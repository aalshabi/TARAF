...
export const metadata: Metadata = {
  title: "الاستقدام المنزلي | الترف للاستقدام",
  description:
    "استقدام عمالة منزلية من الفلبين، إندونيسيا، بنغلاديش، كينيا، أوغندا وإثيوبيا. إجراءات سريعة وضمانات شاملة مع الترف للاستقدام.",
  keywords: [
      ...
      <section className="bg-gradient-to-bl from-navy via-[#0d2a52] to-[#003366] py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-200 text-lg md:text-xl mb-8 max-w-2xl mx-auto">
            آلاف الأسر السعودية تثق بالترف للاستقدام. انضم إليهم واستمتع بخدمة
            موثوقة.
          </p>
